...
import { OMNIDEF } from './cryptoCurrencyHandsOnLatamEnglish_def.js';
import tmpl from './cryptoCurrencyHandsOnLatamEnglish.html';
import tmpl_nds from './cryptoCurrencyHandsOnLatamEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class cryptoCurrencyHandsOnLatamEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
