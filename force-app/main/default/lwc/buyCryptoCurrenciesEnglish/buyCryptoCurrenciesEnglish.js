...
import { OMNIDEF } from './buyCryptoCurrenciesEnglish_def.js';
import tmpl from './buyCryptoCurrenciesEnglish.html';
import tmpl_nds from './buyCryptoCurrenciesEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class buyCryptoCurrenciesEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
