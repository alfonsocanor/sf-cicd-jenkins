...
import { OMNIDEF } from './dcCommunityUserEnglish_def.js';
import tmpl from './dcCommunityUserEnglish.html';
import tmpl_nds from './dcCommunityUserEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dcCommunityUserEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
