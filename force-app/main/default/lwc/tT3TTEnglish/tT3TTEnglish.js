...
import { OMNIDEF } from './tT3TTEnglish_def.js';
import tmpl from './tT3TTEnglish.html';
import tmpl_nds from './tT3TTEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class tT3TTEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
