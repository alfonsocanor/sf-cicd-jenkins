...
import { OMNIDEF } from './sfiNosCacheIssueEnglish_def.js';
import tmpl from './sfiNosCacheIssueEnglish.html';
import tmpl_nds from './sfiNosCacheIssueEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sfiNosCacheIssueEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
