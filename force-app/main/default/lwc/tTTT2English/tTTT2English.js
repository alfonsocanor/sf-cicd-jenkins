...
import { OMNIDEF } from './tTTT2English_def.js';
import tmpl from './tTTT2English.html';
import tmpl_nds from './tTTT2English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class tTTT2English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
